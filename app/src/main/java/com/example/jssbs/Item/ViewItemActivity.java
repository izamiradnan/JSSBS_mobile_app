...
import com.example.jssbs.ViewHolder.ItemAdapterBuyer;
...
public class ViewItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ItemAdapterBuyer[] adapter = new ItemAdapterBuyer[1];
        ...
        mUserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter[0] = new ItemAdapterBuyer(ViewItemActivity.this,itemArrayList);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ViewItemActivity.this, "Error",Toast.LENGTH_SHORT).show();
            }
        });
    }
}
