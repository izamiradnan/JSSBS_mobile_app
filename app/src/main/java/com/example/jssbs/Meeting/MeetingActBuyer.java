...
public class MeetingActBuyer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meeting_act_buyer);
        ...
        updateMeetingBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(MeetingActBuyer.this, UpdateMeetingActivity.class) );
        ...
        cancelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        ...
                        if(dataSnapshot.hasChildren()){
                            ...
                            mItemRef.child(ItemID).updateChildren(productMap2).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    Toast.makeText(MeetingActBuyer.this, "Item Cancelled", Toast.LENGTH_SHORT).show();
                ...
                if(mAuth.getCurrentUser().getUid().equals(BuyerID)){
                    drMeeting.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(MeetingActBuyer.this, "Item Deleted", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(MeetingActBuyer.this, MainActivity.class));
                            } else {
                                Toast.makeText(MeetingActBuyer.this, "Delete fail", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
